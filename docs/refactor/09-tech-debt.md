...
- 2026-05-15: Layer-boundary refactor waves 0–8 closed. Register: [`tech-debt-layer-boundaries.md`](./tech-debt-layer-boundaries.md). LB-C1/C2/C5 done; LB-C3/C4 partial (native eval + train metadata IO in services). Residual: [`layer-boundary-continuation.md`](./layer-boundary-continuation.md) (`train_yolo`/`test_yolo`, ONNX/TRT runners, report_writer split).

...
- 2026-05-15: Layer-boundary refactor waves 0–8 closed. Register: [`tech-debt-layer-boundaries.md`](./tech-debt-layer-boundaries.md). LB-C1/C2/C5 done (backends implementations, `core/testing` artifact paths, analyze facade dispatch). Residual: [`layer-boundary-continuation.md`](./layer-boundary-continuation.md) (LB-C3/C4 train/test monoliths, report_writer split).

...
| Dataset catalog/splits | `dataset_augment.py`, `dataset_balance.py`, `dataset_orient.py`, `dataset_prune.py` | Repeated dataset lookup and split logic | `cli/datasets/common.py` |

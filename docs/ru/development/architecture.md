...
Маршрутизация команд — в `cli.py` (`_forward_argparse_command`, подкоманды `analyze`, приложения `cli_entrypoints/*`). Таблица ниже помогает найти модуль для правки.

...
def _prompt_interactive_classes(
    ...
    from smartrain.cli_entrypoints.support.cli_prompts import prompt_choice, prompt_multi_choice_csv, prompt_text
...
def _prompt_interactive_datasets(args, available_names: list[str]) -> None:
    from smartrain.cli_entrypoints.support.cli_prompts import prompt_choice, prompt_multi_choice_csv
...
def prompt_interactive_compare_args(args, available_names: list[str]) -> None:
    from smartrain.cli_entrypoints.support.cli_prompts import print_numbered_options, prompt_choice, prompt_text
